...
typedef enum {
	...
	CSKBURN_ERR_EMMC_INFO_FAILED = 6005,
	CSKBURN_ERR_EMMC_NOT_DETECTED = 6006,
	...
	CSKBURN_ERR_FLASH_LOCK_FAILED = 7009,
	CSKBURN_ERR_FLASH_UNLOCK_FAILED = 7010,
	CSKBURN_ERR_FLASH_INDEX_FAILED = 7011,
